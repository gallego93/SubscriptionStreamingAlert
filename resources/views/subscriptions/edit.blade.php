                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2 sm:gap-6 sm:mb-5">
                    ...
                    <div class="w-full">
                        ...
                        <input type="date" name="initial_date" id="initial_date"
                            ...
                            value="{{isset($subscription) ? $subscription->initial_date : ''}}"
                            placeholder="{!! trans('subscriptions.initial_date') !!}">
                    </div>
                    ...
                    <div class="w-full">
                        ...
                        <input type="date" name="final_date" id="final_date"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            value="{{isset($subscription) ? $subscription->final_date : ''}}"
                        ...
                        <ul
                            ...
                            <li class="w-full border-b border-gray-200 rounded-t-lg dark:border-gray-600">
                                <div class="flex items-center ps-3">
                                    <input id="vue-checkbox" type="checkbox" name="status" value="0" {{
                                        $subscription->status ?
                                    'checked' : '' }}
