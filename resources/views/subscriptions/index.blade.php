    ...
    <x-slot name="header">
        <div class="h-10 grid grid-cols-3 gap-4 content-start">
            <a href="{{ route('subscriptions.create') }}"> 
                <button class="font-semibold ml-2 bg-blue-500 text-white px-2 py-1 rounded">{!! trans('subscriptions.add_new_record') !!}</button>
            </a>
            <form action="{{ route('subscriptions.index') }}" method="GET">
                <input class="rounded px-2 py-1" name="search" value="{{ request('search') }}" placeholder="Buscar suscripciones...">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4 text-right">
                    <a href="{{ route('subscriptions.edit', $row->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">{!! trans('subscriptions.edit') !!}</a>
                </td>
                <td class="px-6 py-4 text-right">
